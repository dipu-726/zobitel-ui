...
const defaultFaqs = [
  ...
  },
  {
    id: 3,
    question:
      "How does Automated Lead Qualification save time for sales teams?",
    answer:
  ...
  },
  {
    id: 5,
    question:
      "Is the platform compliant with legal frameworks like TCPA and GDPR?",
    answer:
  ...
  },
  {
    id: 7,
    question:
      "How do voice and sentiment analytics inform better sales strategy?",
    answer:
  ...
  },
  {
    id: 8,
    question:
      "Can AI agents collaborate with human teams during or after calls?",
    answer:
    ...
    <section className="px-4 py-20 mx-auto max-w-7xl">
      <div className="">
        ...
        <p className="text-center mb-6 sm:mb-6 text-lg text-gray-500">
          Still wondering how it works? Let's make it clear.
        </p>
